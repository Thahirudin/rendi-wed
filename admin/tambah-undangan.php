      ...
      <div class="bg-white p-5 rounded-lg shadow-lg">
        ...
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="mt-5">
            ...
            <select name="tipe" id="tipe" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#213555] focus:border-[#213555] block w-full p-2.5" required>
          ...
          <div class="mt-5">
            ...
            <select name="kategori" id="kategori" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#213555] focus:border-[#213555] block w-full p-2.5" required>
          ...
          <div class="mt-5">
            ...
            <input type="file" id="gambar" name="gambar" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#213555] focus:border-[#213555] block w-full p-2.5" required/>
          </div>
          <div class="mt-5">
            <label for="link" class="block mb-2 text-lg font-medium text-gray-900">Link Preview</label>
            <input type="text" id="link" name="link" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#213555] focus:border-[#213555] block w-full p-2.5" required/>
          </div>

  ...
  <main class="py-4 w-[90%] mx-auto lg:w-[75%] flex flex-col gap-8">
    ...
    <section>
      <div class="bg-white p-4 rounded-lg shadow-lg">
        <h2 class="text-[22px] font-bold mb-5 text-emerald-700">
          Data Undangan
        </h2>
        <a href="<?php echo $baseurl ?>admin/tambah-undangan.php" class="mb-5 inline-block rounded-lg text-white px-4 py-2 bg-emerald-700 hover:bg-emerald-500 duration-300">Tambah Undangan</a>
                ...
                <tr>
                  ...
                  <td>
                    <div class="flex gap-2">
                      <a href="<?php echo $row['link'] ?>" class="flex justify-center items-center bg-emerald-700 text-center w-full py-2 px-4 rounded-lg text-white hover:bg-emerald-500 duration-300">
    ...
    <section>
      <div class="bg-white p-4 rounded-lg shadow-lg">
        ...
        <a href="<?php echo $baseurl ?>admin/tambah-tipe.php" class="mb-5 inline-block rounded-lg text-white px-4 py-2 bg-emerald-700 hover:bg-emerald-500 duration-300">Tambah Tipe</a>
        <div class="overflow-x-auto">
    ...
    <section>
      <div class="bg-white p-4 rounded-lg shadow-lg">
        ...
        <a href="<?php echo $baseurl ?>admin/tambah-kategori.php" class="mb-5 inline-block rounded-lg text-white px-4 py-2 bg-emerald-700 hover:bg-emerald-500 duration-300">Tambah Kategori</a>
        <div class="overflow-x-auto">

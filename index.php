  ...
  <header class="bg-[#0000009d] text-white fixed w-full">
    <nav class="border-gray-200 max-w-[1200px] mx-auto w-[90%] lg:w-full">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-4">
        ...
        <button data-collapse-toggle="navbar-default" type="button" 0 class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-white rounded-lg lg:hidden hover:bg-[#4F709C] focus:outline-none focus:ring-2 focus:ring-[#4F709C]" aria-controls="navbar-default" aria-expanded="false">
        ...
        <div class="hidden w-full lg:block lg:w-auto" id="navbar-default">
          <ul class="font-medium flex flex-col p-4 lg:p-0 mt-4 border border-gray-100 rounded-lg lg:flex-row lg:space-x-8 rtl:space-x-reverse lg:mt-0 md:border-0 bg-white lg:bg-inherit">
            <li>
              <a href="#" class="block py-2 px-3 text-slate-800 lg:text-white rounded hover:bg-[#4F709C] hover:text-white lg:hover:bg-transparent lg:border-0 lg:hover:text-[#4F709C] lg:p-0">Home</a>
            </li>
            <li>
              <a href="#tentang" class="block py-2 px-3 text-slate-800 lg:text-white rounded hover:bg-[#4F709C] hover:text-white lg:hover:bg-transparent lg:border-0 lg:hover:text-[#4F709C] lg:p-0">Tentang</a>
            </li>
            <li>
              <a href="#katalog" class="block py-2 px-3 text-slate-800 lg:text-white rounded hover:bg-[#4F709C] hover:text-white lg:hover:bg-transparent lg:border-0 lg:hover:text-[#4F709C] lg:p-0">Katalog</a>
            </li>
            <li>
              <a href="./login.php" class="block py-2 px-3 text-slate-800 lg:text-white rounded hover:bg-[#4F709C] hover:text-white lg:hover:bg-transparent lg:border-0 lg:hover:text-[#4F709C] lg:p-0">Login</a>
            </li>
          </ul>
        </div>
      </div>
  ...
  <di>
    <section class="bg-center bg-no-repeat bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg')] bg-gray-700 bg-blend-multiply">
      <div class="px-4 mx-auto max-w-[1200px] w-[90%] lg:w-full text-center py-24 lg:py-56">
        ...
        <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
          <a href="#katalog" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-[#4F709C] hover:bg-[#213555] duration-300 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
            Order Sekarang
    ...
    <section class="pb-12 pt-24" id="tentang">
      <div class="max-w-[1200px] w-[90%] mx-auto lg:w-full">
          <h2 class="text-center font-extrabold text-[#4F709C] text-[30px] mb-6">
          Tentang Kami
        </h2>
      ...
      <section class="py-12">
        <div class="max-w-[1200px] w-[90%] mx-auto lg:w-full h-full">
          <h2 class="text-center font-extrabold text-[30px] mb-6">
            <span class="text-[#4F709C]">Katalog</span> Undangan <?php echo $rowTipe["nama"] ?>
          </h2>
            ...
            <?php while ($row = mysqli_fetch_assoc($undangan)) : ?>
              <div class="bg-white border-2 border-gray rounded-lg">
                ...
                <div class="flex flex-col p-4">
                  ...
                  <span class="text-[14px] text-slate-600 font-semibold"><?php $kategori = "select nama from kategori where id = " . $row["kategori"];
                        $kat = mysqli_query($koneksi, $kategori);
                        $k = mysqli_fetch_assoc($kat);
                        echo $k["nama"]; ?></span>
                  <div class="flex gap-1 justify-between">
                    <a href="<?php echo $row["link"] ?>" class="block p-3 w-full text-center font-semibold bg-[#213555] text-white rounded-lg hover:bg-[#4F709C] duration-500">Preview</a>
                    <a href="https://wa.me/621363489750?text=Halo%20Kak,%20saya%20ingin%20memesan%20undangan%20*<?php echo $row["nama"] ?>*" target="_blank" class="block p-3 w-full text-center font-semibold bg-white border-2 border-[#213555] text-[#213555] rounded-lg hover:bg-white-800 duration-500">Pesan</a>
                  </div>
                </div>
              </div>
            <?php endwhile; ?>
    ...
    <footer class="py-4 bg-[#213555] text-white text-center mx-auto w-full">
